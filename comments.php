 ...
 * handled by a callback to jenhail_comment() which is
...
<div id="comments" class="row">
	<?php if ( post_password_required() ) : ?>
		<p class="nopassword"><?php _e( 'This post is password protected. Enter the password to view any comments.', 'jenhail' ); ?></p>
	<?php
	...
	<?php if ( have_comments() ) : ?>
		...
		<ol class="commentlist">
			<?php
				 ...
				 * See jenhail_comment() in inc/functions/comments.php for more.
				 */
				wp_list_comments( array( 'callback' => 'jenhail_comment' ) );
			?>
		</ol>

		<?php if ( get_comment_pages_count() > 1 && get_option( 'page_comments' ) ) : // are there comments to navigate through ?>
		<nav id="comment-nav-below">
			<h1 class="assistive-text"><?php _e( 'Comment navigation', 'jenhail' ); ?></h1>
			<div class="nav-previous"><?php previous_comments_link( __( '&larr; Older Comments', 'jenhail' ) ); ?></div>
			<div class="nav-next"><?php next_comments_link( __( 'Newer Comments &rarr;', 'jenhail' ) ); ?></div>
		</nav>
	...
	?>
		<p class="nocomments"><?php _e( 'Comments are closed.', 'jenhail' ); ?></p>
	<?php endif; ?>
